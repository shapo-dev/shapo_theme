...
{block name="frontend_detail_tabs_description" append}
        <a href="#" class="tab--link" title="{s namespace="frontend/detail" name='Pflegehinweise'}{/s}" data-tabname="{s namespace="frontend/detail" name='Pflegehinweise'}{/s}"><i class="ti ti-spray"></i> {s namespace="frontend/detail" name='Pflegehinweise'}{/s}</a>
{/block}

{* New Tab container *}
{block name="frontend_detail_tabs_content_description" append}
        <div class="tab--container">
            <div class="tab--header"><a class="tab--title" title="{s namespace="frontend/detail" name='Pflegehinweise'}{/s}" href="#">{s namespace="frontend/detail" name='Pflegehinweise'}{/s}</a></div>

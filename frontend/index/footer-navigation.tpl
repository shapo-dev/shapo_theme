        ...
        {block name="frontend_index_footer_column_newsletter_content"}
            <div class="column--content">
                ...
                {block name="frontend_index_footer_column_newsletter_form"}
                    ...
                    <form class="newsletter--form" id="ktv2-form-143491" accept-charset="UTF-8" method="post" action="https://www.klick-tipp.com/api/subscriber/signin.html" >
                    <input type="hidden" id="FormField_ApiKey" name="apikey" value="3jjdz1ur5z8z9bb5" />
                    <input type="hidden" id="FormField_Digit" name="fields[fieldDigit]" value="" />
                        ...
                        {block name="frontend_index_footer_column_newsletter_form_field"}
                            <input id="FormField_EmailAddress" type="email" name="email" class="newsletter--field" placeholder="{s name="IndexFooterNewsletterValue"}{/s}" />

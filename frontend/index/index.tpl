...
<body data-id="body--{controllerName|lower}" class="{block name="frontend_index_body_classes"}{strip}
    ...
    {block name="frontend_index_page_wrap"}
        <div class="page-wrap">
            ...
            {block name='frontend_index_navigation'}
                <header id="header--{controllerName|lower}" class="header-main">
...
{* block name="top_feat"}
   ...
   {include file='frontend/index/top-feat.tpl'}
   {/if}
{/block *}
    ...
    {* time based offers *}
    {if $Controller|lower == 'index'}
    {block name="frontend_index_offers"}
